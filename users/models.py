...
class UserVerifyModel(models.Model):
    ...
    addresses = models.CharField(max_length=1024, blank=True, null=True)
...
class OrderModel(models.Model):
    ...
    email = models.ForeignKey(UserVerifyModel, on_delete=models.CASCADE, related_name="user_mail_sel")
    phone = models.IntegerField(blank=True, null=True)
